...
{
public: 
	EnemyLaser(float og_x, float og_y,float dir_x, float dir_y, float speed, sf::Color newColor) : Laser(og_x, og_y, speed, newColor)
	{
	...
	/******************************************************************************************************
	* Function:				EnemyLaser()
	* Description:			constructor for enemyLaser class: this will set up the enemy's laser
